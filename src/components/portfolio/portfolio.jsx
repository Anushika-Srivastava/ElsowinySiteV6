                     ...
                     <div className="row">
                         <div className="col-lg-12 visibleOverParticles">
                             <div className="section-title text-center service-style--3 mb--30 mb_sm--0">
                                 <h2 className="title">Elsowiny <span className="blueify">Laboratory</span></h2>
                     ...
                     <div className="row">
                         <div className="col-lg-12 visibleOverParticles">
                             <div className="view-more-btn mt--60 mt_sm--30 text-center">
                                 <a className="rn-button-style--2 btn-solid" target="_blank" rel="noopener noreferrer" href="https://github.com/elsowiny"><span>View all on Github</span></a>
                             </div>
                         </div>
                     </div>
                 </div>
